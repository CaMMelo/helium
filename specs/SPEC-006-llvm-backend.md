...
- [x] Reference counting frees unused values.
...
- None. The previous runtime linking issue that prevented end-to-end codegen
  tests from producing executables has been resolved, and all acceptance
  criteria above are now passing.
